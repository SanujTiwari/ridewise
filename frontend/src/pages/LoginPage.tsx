...
export const LoginPage: React.FC = () => {
  ...
  const [email, setEmail] = useState('sanuj@ridewise.io');
    ...
    <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full glass-panel p-8 sm:p-10 rounded-3xl border border-gray-800 space-y-8 shadow-2xl">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-white">Sign In to RideWise</h2>
          <p className="text-xs text-gray-400">Enter your credentials to access your transport portal</p>
        </div>
